        ...
        <div className="container">
            {
                product.map((e,i)=>{
                    ...
                    return <>
                        <div key={i} className="card mb-5 border border-secondary" style={{ minWidth: '80%',maxWidth:'300px'}}>
                            <div className="row g-0">
                                <div className="col-md-3">
                                    <img src={e.image} className="img-fluid rounded-start cardImage" style={{ width: "200px", height: "300px"
            }}alt="..."/>
                                </div>
                                <div className="col-md-9">
                                    <div className="card-body px-3">                                    
                                        ...
                                        <button type='button'className='btn btn-success
                                         ...
                                         float-end my-3'>Proceed to pay</button>
                                    </div>
                                </div>
                            </div>                      
                        </div>
